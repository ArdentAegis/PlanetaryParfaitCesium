...
namespace TerrainEngine.Tools
{
    ...
    public class PerPixelDataReader : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            if (readingData)
            {
                ...
                else // existing layers
                {
                    ...
                    // if Cesium Moon is being used, use physics raycast onto Cesium mesh
                    if (SceneMaterializer.singleton.useCesium){
                        CalculateRayCesium();
                    }
                    // use original raymarch for non-Cesium terrains
                    else
                    {
                        CalculateRay();
                    }
        ...
        /// <summary>
        /// Raycasts onto Cesium Moon mesh and displays layer data at hit point to user
        /// </summary>
        ...
        /// <summary>
        /// Creates raycast from user's mouse/controller to the JMARS terrain
        /// </summary>
